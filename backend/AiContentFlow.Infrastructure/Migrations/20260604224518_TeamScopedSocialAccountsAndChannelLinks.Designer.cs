...
namespace AiContentFlow.Infrastructure.Migrations
{
    ...
    [Migration("20260604224518_TeamScopedSocialAccountsAndChannelLinks")]
    partial class TeamScopedSocialAccountsAndChannelLinks
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AiContentFlow.Domain.Models.Campaign", b =>
                {
                    ...
                    b.Property<string>("TargetAudienceOverride")
                        .HasMaxLength(1000)
                        .HasColumnType("character varying(1000)");
                    ...
                    b.Property<string>("ToneOfVoiceOverride")
                        .HasMaxLength(300)
            ...
            modelBuilder.Entity("AiContentFlow.Domain.Models.ChannelBranding", b =>
                {
                    ...
                    b.Property<string>("BrandSummary")
                        .HasMaxLength(2000)
                    ...
                    b.Property<string>("ContentPillarsCsv")
                        .HasMaxLength(4000)
                        .HasColumnType("character varying(4000)");
            ...
            modelBuilder.Entity("AiContentFlow.Domain.Models.TeamBrandStudio", b =>
                {
                    ...
                    b.PrimitiveCollection<List<string>>("AudienceSignals")
                        .IsRequired()
                        .HasColumnType("text[]");
                    ...
                    b.Property<string>("DefaultBrandSummary")
                        .HasMaxLength(2000)
                        .HasColumnType("character varying(2000)");

                    b.Property<string>("DefaultCampaignObjective")
                        .HasMaxLength(120)
                        .HasColumnType("character varying(120)");

                    b.PrimitiveCollection<List<string>>("DefaultContentPillars")
                        .IsRequired()
                        .HasColumnType("text[]");

                    b.Property<string>("DefaultMission")
                        .HasMaxLength(1000)
                        .HasColumnType("character varying(1000)");
                    ...
                    b.Property<string>("DefaultToneOfVoice")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");
                    ...
                    b.Property<string>("EnrichedAdCopyStyle")
                        .HasMaxLength(2000)
                        .HasColumnType("character varying(2000)");

                    b.Property<string>("EnrichedBrandArchetype")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)");

                    b.PrimitiveCollection<List<string>>("EnrichedBrandPersonality")
                        .IsRequired()
                        .HasColumnType("text[]");

                    b.Property<string>("EnrichedLinkedInVoice")
                        .HasMaxLength(2000)
                        .HasColumnType("character varying(2000)");

                    b.PrimitiveCollection<List<string>>("EnrichedMessagingPriorities")
                        .IsRequired()
                        .HasColumnType("text[]");

                    b.Property<string>("EnrichedPositioningStatement")
                        .HasMaxLength(2000)
                        .HasColumnType("character varying(2000)");

                    b.Property<string>("EnrichedVisualDirectionNotes")
                        .HasMaxLength(2000)
                        .HasColumnType("character varying(2000)");

                    b.PrimitiveCollection<List<string>>("KeyMessages")
                        .IsRequired()
                        .HasColumnType("text[]");
                    ...
                    b.PrimitiveCollection<List<string>>("ToneOfVoice")
                        .IsRequired()
                        .HasColumnType("text[]");
                    ...
                    b.PrimitiveCollection<List<string>>("ValueProposition")
                        .IsRequired()
                        .HasColumnType("text[]");

                    b.PrimitiveCollection<List<string>>("VisualCtaTexts")
                        .IsRequired()
                        .HasColumnType("text[]");

                    b.Property<string>("VisualFaviconUrl")
                        .HasMaxLength(1000)
                        .HasColumnType("character varying(1000)");

                    b.PrimitiveCollection<List<string>>("VisualFontFamilies")
                        .IsRequired()
                        .HasColumnType("text[]");

                    b.Property<bool>("VisualHasImages")
                        .HasColumnType("boolean");

                    b.Property<bool>("VisualHasLogo")
                        .HasColumnType("boolean");

                    b.Property<string>("VisualHeroText")
                        .HasMaxLength(300)
                        .HasColumnType("character varying(300)");

                    b.PrimitiveCollection<List<string>>("VisualImageUrls")
                        .IsRequired()
                        .HasColumnType("text[]");

                    b.Property<string>("VisualLogoUrl")
                        .HasMaxLength(1000)
                        .HasColumnType("character varying(1000)");

                    b.PrimitiveCollection<List<string>>("VisualPrimaryColors")
                        .IsRequired()
                        .HasColumnType("text[]");

                    b.Property<string>("VisualRenderMode")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)");

                    b.Property<string>("VisualScreenshotPath")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");

                    b.PrimitiveCollection<List<string>>("VisualSecondaryColors")
                        .IsRequired()
                        .HasColumnType("text[]");
                    ...
                    b.PrimitiveCollection<List<string>>("VoiceGuidelinesDo")
                        .IsRequired()
                        .HasColumnType("text[]");

                    b.PrimitiveCollection<List<string>>("VoiceGuidelinesDont")
                        .IsRequired()
                        .HasColumnType("text[]");
