...
public class CampaignServiceTests
{
    ...
    public async Task GetByIdAsync_WhenRequesterIsNotTeamMember_ThrowsUnauthorizedAccessException()
    {
        ...
        var service = CreateService(campaignRepo, linkRepo, contentPostRepo, teamRepo);
    ...
    public async Task LinkAndUnlinkContentPostAsync_WhenSameTeamAndValid_Succeeds()
    {
        ...
        teamRepo.Setup(x => x.GetUserMembershipAsync(teamId, "user-1"))
            .ReturnsAsync(new UserTeam { Id = Guid.NewGuid(), TeamId = teamId, UserId = "user-1", Role = TeamRole.Owner, JoinedAt = DateTime.UtcNow });
    ...
    {
        return new CampaignService(campaignRepo.Object, linkRepo.Object, contentPostRepo.Object, teamRepo.Object);
    }
}
